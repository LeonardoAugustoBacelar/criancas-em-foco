import { buildWhatsAppLink, CLINIC_WHATSAPP, DEFAULT_WHATSAPP_MESSAGE } from "@/lib/whatsapp";

export default function WhatsAppFloatButton() {
  const href = buildWhatsAppLink(CLINIC_WHATSAPP, DEFAULT_WHATSAPP_MESSAGE);
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-[#25D366] p-4 text-white shadow-lg shadow-black/20 transition-transform hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#25D366] sm:px-5"
    >
      <svg
        viewBox="0 0 32 32"
        aria-hidden="true"
