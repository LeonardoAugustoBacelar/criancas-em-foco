  ...
  return (
    <div className="flex flex-wrap gap-2">
      ...
      <button
        ...
        className="rounded-md bg-primary-100 px-3 py-1.5 text-xs font-semibold text-primary-700 hover:bg-primary-200 disabled:opacity-50"
      >
        Concluir
      </button>
      <button
        ...
        className="rounded-md bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-100 disabled:opacity-50"
      >
        Cancelar
      </button>
    </div>
